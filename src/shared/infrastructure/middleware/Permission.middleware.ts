...
import { ProfileMongoRepository } from "../../../security-system/infrastructure";
import { UserAuthDTO } from "../../../security-system/domain";
import { ValidateActionInSystem } from "../../../security-system/applications";
...
export const PermissionMiddleware = async (req, res) => {
  ...
  let URL = `${req.baseUrl}${req.url}`.split("?")[0].replace(/\/$/, "");
